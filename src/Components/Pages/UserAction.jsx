import { faUsers ,faBoxesStacked,faSackDollar,faMoneyCheckDollar,faChartLine, faChartPie,faGlobe , faStar, faFilter, faRightFromBracket } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <>
        ...
        <div className='w-[20%] h-screen bg-[#051b32] fixed'>
            ...
            <Link to="/adminpanel/adduser" className="pt-[20px] cursor-pointer ">
