...
const OrderSeeMore = ({open,onClose}) => {    
    if(!open) return null

  return (
    <div className='w-full h-auto right-0 left-0 top-0 bottom-0 fixed bg-slate-800 backdrop-blur-[2px] bg-opacity-80 overflow-auto'>
